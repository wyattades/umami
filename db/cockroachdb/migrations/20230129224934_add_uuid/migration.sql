-- AlterTable
-- ALTER TABLE "account" ADD COLUMN "account_uuid" UUID NOT NULL DEFAULT gen_random_uuid();
...
-- AlterTable
ALTER TABLE "event" ADD COLUMN "event_uuid" UUID NOT NULL DEFAULT gen_random_uuid();
